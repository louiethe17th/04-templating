...
Article.prototype.toHtml = function () {
  ...
  let templateShow = Handlebars.compile(articleTemplate);
  ...
  // DONE-REVIEW: The ternary operator above accomplishes this same logic.
  // if(this.publishedOn) {
  ...
  return templateShow(this);

};

// COMMENT: Why are there parentheses around "(a,b)" in the .sort() method, but not around the "articleObject" or "article" arguments in the .forEach() methods?
// You have to wrap the inputs in an arrow function only when there is more than one input. 
rawData.sort((a, b) => {
